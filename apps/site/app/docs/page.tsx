...
const operatorGuides: Array<[string, string, string]> = [
  ...
  [`${site.github}/blob/main/docs/live-soak-dashboard.md`, 'Live soak dashboard', 'Explains live status, SSE, logs, metrics, and artifact fallbacks.'],
  [`${site.github}/blob/main/docs/sustained-run-operator-guide.md`, 'Sustained-run operator guide', 'Persistent-host workflow for starting, watching, restarting, and archiving a live soak.'],
