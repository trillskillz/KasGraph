...
fn build_registry() -> Vec<DetectorEntry> {
    vec![
        ...
        opensilver(DetectorKind::OpenSilverOwnable, 0x01, &[("owner_pubkey", 32), ("pending_owner_pubkey", 32)]),
        opensilver(DetectorKind::OpenSilverMultisig, 0x02, &[("signer_pubkeys", 96), ("threshold", 1)]),
        opensilver(DetectorKind::OpenSilverTimeLock, 0x03, &[("unlock_daa_score", 8), ("beneficiary_pubkey", 32)]),
        opensilver(DetectorKind::OpenSilverVault, 0x04, &[("owner_pubkey", 32), ("recovery_pubkey", 32), ("recovery_delay_blocks", 8)]),
        opensilver(DetectorKind::OpenSilverEscrowBilateral, 0x05, &[("buyer_pubkey", 32), ("seller_pubkey", 32), ("arbiter_pubkey", 32)]),
        opensilver(DetectorKind::OpenSilverEscrowMilestone, 0x06, &[("buyer_pubkey", 32), ("seller_pubkey", 32), ("milestone_root", 32), ("milestone_count", 1)]),
        opensilver(DetectorKind::OpenSilverStreamingPayment, 0x07, &[("sender_pubkey", 32), ("recipient_pubkey", 32), ("rate_per_block", 8), ("start_daa", 8)]),
        opensilver(DetectorKind::OpenSilverVesting, 0x08, &[("beneficiary_pubkey", 32), ("cliff_daa", 8), ("end_daa", 8), ("total_amount", 8)]),
        opensilver(DetectorKind::OpenSilverDeadMansSwitch, 0x09, &[("owner_pubkey", 32), ("heir_pubkey", 32), ("checkin_interval_blocks", 8), ("last_checkin_daa", 8)]),
        opensilver(DetectorKind::OpenSilverSocialRecovery, 0x0A, &[("owner_pubkey", 32), ("guardian_root", 32), ("guardian_threshold", 1), ("recovery_delay_blocks", 8)]),
        opensilver(DetectorKind::OpenSilverAtomicSwapHTLC, 0x0B, &[("alice_pubkey", 32), ("bob_pubkey", 32), ("hash_lock", 32), ("timeout_daa", 8)]),
        opensilver(DetectorKind::OpenSilverFreelancePayroll, 0x0C, &[("payer_pubkey", 32), ("worker_root", 32), ("worker_count", 1), ("period_blocks", 8)]),

        // Native KCC20.
        opensilver(DetectorKind::KCC20Asset, 0x20, &[("controller_covenant_id", 32), ("decimals", 1), ("total_supply", 16), ("mint_nonce", 8)]),
        opensilver(DetectorKind::KCC20OwnableController, 0x21, &[("owner_pubkey", 32), ("pending_owner_pubkey", 32), ("asset_covenant_id", 32)]),
        opensilver(DetectorKind::KCC20PausableController, 0x22, &[("owner_pubkey", 32), ("paused_flag", 1), ("asset_covenant_id", 32)]),
        opensilver(DetectorKind::KCC20CappedController, 0x23, &[("owner_pubkey", 32), ("remaining_allowance", 16), ("asset_covenant_id", 32)]),
        opensilver(DetectorKind::KCC20VestingController, 0x24, &[("owner_pubkey", 32), ("schedule_root", 32), ("schedule_count", 1), ("asset_covenant_id", 32)]),
    ]
}
...
fn opensilver(kind: DetectorKind, discriminator: u8, fields: &[(&'static str, usize)]) -> DetectorEntry {
    ...
    for &(field, len) in fields {
        ...
        windows.push(MaskedWindow { field: field_label(kind, field), offset: cursor, len });
        cursor += len;
    }
